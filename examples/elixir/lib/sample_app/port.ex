defmodule SampleApp.Port do
  ...
  # --- driver error codes (second byte of error reply) ---
  # Returned by the driver when no merged frame is available yet.
  @err_no_data_yet 0x41
  ...
  @doc """
  Driver error code meaning "no data yet".
  """
  @spec err_no_data_yet_code() :: 0x41
  def err_no_data_yet_code(), do: @err_no_data_yet
